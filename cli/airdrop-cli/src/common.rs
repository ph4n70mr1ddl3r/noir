...
/// Used for comparison with little-endian private keys when needed.
/// n = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141
pub const SECP256K1_ORDER_LE: [u8; 32] = [
...
/// Used to validate ECDSA signature low-s values to prevent malleability.
